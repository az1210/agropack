...
//                         1: pw.FixedColumnWidth(45), // Film
//                         2: pw.FixedColumnWidth(45), // Fabric Color
//                         3: pw.FixedColumnWidth(35), // Weight
//                         4: pw.FixedColumnWidth(35), // Quantity
//                         5: pw.FixedColumnWidth(30), // Unit Price
//                         6: pw.FixedColumnWidth(45), // Amount
...
//     final bool isAdmin = customUser != null && customUser.role == 'admin';
...
import 'package:agro_packaging/features/sales/providers/order_provider.dart';
import 'package:agro_packaging/features/sales/providers/quotation_provider.dart';
import 'package:flutter/foundation.dart';
import 'package:go_router/go_router.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart' show rootBundle;
                ...
                child: pw.Column(
                  ...
                  children: [
                    ...
                    pw.Table(
                      ...
                      columnWidths: {
                        0: pw.FixedColumnWidth(80), // Product
                        1: pw.FixedColumnWidth(45), // Film/Block
                        2: pw.FixedColumnWidth(45), // Fabric Color
                        3: pw.FixedColumnWidth(35), // Weight
                        4: pw.FixedColumnWidth(35), // Quantity
                        5: pw.FixedColumnWidth(30), // Unit Price
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                if (isAdmin && quotation.status == 'pending_admin_verification')
                  ElevatedButton.icon(
                    onPressed: () async {
                      try {
                        await ref
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('Quotation approved!'),
